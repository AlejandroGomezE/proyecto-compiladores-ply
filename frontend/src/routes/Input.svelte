...
<div class="flex flex-col">
  ...
  <button
    ...
    disabled={loading}
    class="mt-auto rounded-md border border-transparent bg-green-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:opacity-50"
  >
    Compilar
  </button>
</div>
